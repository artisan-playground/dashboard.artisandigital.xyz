# Migration `20200914075153`

This migration has been generated by Kullanan at 9/14/2020, 2:51:53 PM.
...
ALTER TABLE "public"."Project" ADD FOREIGN KEY ("memberId")REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."Task" ADD FOREIGN KEY ("projectId")REFERENCES "public"."Project"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."Task" ADD FOREIGN KEY ("memberId")REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE

# Migration `20200923044352`

This migration has been generated by Kullanan at 9/23/2020, 11:43:53 AM.
...
CREATE TABLE "public"."TaskOnProject" (
"projectId" integer   NOT NULL ,
"taskId" integer   NOT NULL ,
"cretedAt" timestamp(3)   NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE UNIQUE INDEX "TaskOnProject_taskId_unique" ON "public"."TaskOnProject"("taskId")
...
ALTER TABLE "public"."TaskOnProject" ADD FOREIGN KEY ("projectId")REFERENCES "public"."Project"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."TaskOnProject" ADD FOREIGN KEY ("taskId")REFERENCES "public"."Task"("id") ON DELETE CASCADE ON UPDATE CASCADE

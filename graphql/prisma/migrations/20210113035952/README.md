# Migration `20210113035952`

This migration has been generated by Kullanan Thanachotnan at 1/13/2021, 10:59:53 AM.
...
CREATE TABLE "public"."FormComponent" (
"id" SERIAL,
"label" text   NOT NULL ,
"type" text   NOT NULL ,
"timestamp" timestamp(3)   DEFAULT CURRENT_TIMESTAMP,
...
ALTER TABLE "public"."FormComponent" ADD FOREIGN KEY("formId")REFERENCES "public"."Form"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."Option" ADD FOREIGN KEY("formComponentId")REFERENCES "public"."FormComponent"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."Example" ADD FOREIGN KEY("formComponentId")REFERENCES "public"."FormComponent"("id") ON DELETE SET NULL ON UPDATE CASCADE
